    ...
    <form onSubmit={handleSubmit} className="edit-person-form" style={{ padding: '20px'}}>
      <div className="form-group" style={{ marginBottom: '20px' }}>
        ...
        <input
          ...
          style={{ width: '100%', padding: '10px', border: '1px solid #3e4094', borderRadius: '4px' }}
        />
      </div>
      <div className="form-group" style={{ marginBottom: '20px' }}>
      ...
      <div className="form-actions" style={{ display: 'flex', justifyContent: 'space-between', marginTop: '30px' }}>
        <button type="submit" className="btn btn-primary" style={{ padding: '10px 20px', backgroundColor: '#3e4094', color: 'white', border: 'none', borderRadius: '4px', cursor: 'pointer' }}>Lưu thông tin</button>
        <button type="button" onClick={onClose} className="btn btn-secondary" style={{ padding: '10px 20px', backgroundColor: '#ffffff', color: '#2e8b57', border: '1px solid #3e4094', borderRadius: '4px', cursor: 'pointer' }}>Hủy bỏ</button>
      </div>
    </form>
  );
};
